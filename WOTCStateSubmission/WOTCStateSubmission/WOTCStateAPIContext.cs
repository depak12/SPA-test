...
{
    public partial class WOTCStateAPIContext : DbContext
    {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
            {
                if (!optionsBuilder.IsConfigured)
                {
                    ...
                    optionsBuilder.UseSqlServer(@"Server=ERS-IT-LT-009;Database= WOTCStateAPI;Trusted_Connection=True;MultipleActiveResultSets=true;");
                }
            }
